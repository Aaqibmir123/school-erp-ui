...
import { isAuthStatusError } from "@/src/utils/requestErrors";
...
export default function SchoolAdminLayout({
  ...
  const pathname = usePathname() ?? "/school-admin";
  ...
  useEffect(() => {
    if (!hasToken || !isAuthStatusError(sessionQuery.error)) return;

    localStorage.removeItem("token");
    router.replace("/");
  }, [hasToken, router, sessionQuery.error]);
