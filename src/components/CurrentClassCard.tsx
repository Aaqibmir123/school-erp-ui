...
const TeacherHome = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <View style={styles.heroTopRow}>
            ...
            <Text style={styles.heroMeta}>
              {students.length > 0 ? `${students.length} students` : "Live class"}
            </Text>
          </View>
          ...
          <Text style={styles.heroTime}>{currentClass.sectionName || "General"}</Text>
      ...
      {isReviewer ? (
        <>
          <Text style={styles.sectionTitle}>Reviewer navigation</Text>
          <View style={styles.grid}>
            <ActionCard
              color={COLORS.primary}
              icon="school-outline"
