      ...
      ========================= */
        ...
        Object.entries(values).forEach(([key, value]) => {
          ...
          if (key === "dateOfBirth" || key === "joiningDate") {
            payload[key] = (value as Dayjs).format("YYYY-MM-DD");
            return;
          }
        ...
        // Upload middleware is temporarily disabled on the backend, so we send
        // JSON here and keep the form stable until file uploads are restored.
    ...
    >
      <Form layout="vertical" form={form} onFinish={handleSubmit}>
        ...
        <Form.Item
          ...
          extra="Profile photo upload is temporarily disabled."
        >
          <Upload
