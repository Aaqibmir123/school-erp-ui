...
import StudentDashboardScreen from "../screens/student/dashboard/DashboardScreen";
...
import StudentTimetableScreen from "../screens/student/timetable/TimetableScreen";
...
const TeacherStack = () => {
  return (
    ...
    >
      ...
      />
      <Stack.Screen name="ExamScreen" component={ExamScreen} options={{ title: "Exams" }} />
      <Stack.Screen
        name="TestRecordsScreen"
        component={StudentTestRecordsScreen}
        options={{ title: "Test Records" }}
      />
      <Stack.Screen
        name="AdmitCardsScreen"
        component={AdmitCardsScreen}
        options={{ title: "Admit Cards" }}
      />
      <Stack.Screen
        name="FeesScreen"
