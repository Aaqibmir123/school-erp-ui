...
const optionalIdsMatch = (left: unknown, right: unknown) =>
  normalizeOptionalId(left) === normalizeOptionalId(right);
...
const StudentsScreen = ({ route }: any) => {
  ...
  const handleSave = async () => {
    try {
      ...
      const payload = {
        classId,
        ...(normalizeOptionalId(sectionId)
          ? { sectionId: normalizeOptionalId(sectionId) }
          : {}),
        subjectId,
        periodId,
        date,
  ...
  const liveMatch =
    !!currentClass &&
    normalizeOptionalId(currentClass.classId) === normalizeOptionalId(classId) &&
    normalizeOptionalId(currentClass.periodId) === normalizeOptionalId(periodId) &&
    normalizeOptionalId(currentClass.subjectId) === normalizeOptionalId(subjectId) &&
    optionalIdsMatch(currentClass.sectionId, sectionId);
